...
//<!--#######################################-->
$html_output .= "<select id=inputselector >";
$html_output .= "<option value=field_1_3>value 1 </option>";
$html_output .= "<option value=field_2_3>value 2 </option>";
$html_output .= "<option value=field_3_3>value 3 </option>";
$html_output .= "<option value=field_4_3>value 4 </option>";
$html_output .= "</select>";
$html_output .= "&nbsp;";
$html_output .= "<input title=Encrypt class=crmbutton onclick=\"window.open('wee-encrypt.php','fieldvalue','top=100,left=200,height=700,width=800,resizable=yes,scrollbars=yes,menubar=no,addressbar=no,status=yes')\" type=button name=button value=\"  Encrypt \">";
$html_output .= "&nbsp;&nbsp;";
$html_output .= "<input title=decrypt class=crmbutton onclick=\"window.open('wee-decrypt.php','fieldvalue','top=100,left=200,height=700,width=800,resizable=yes,scrollbars=yes,menubar=no,addressbar=no,status=yes')\" type=button name=button value=\"  Decrypt \">";
$html_output .= "&nbsp;&nbsp;";
$html_output .= "<input title=sign class=crmbutton onclick=\"window.open('wee-sign.php','fieldvalue','top=100,left=200,height=700,width=800,resizable=yes,scrollbars=yes,menubar=no,addressbar=no,status=yes')\" type=button name=button value=\"  Sign \">";
$html_output .= "&nbsp;&nbsp;";
$html_output .= "<input title=verify class=crmbutton onclick=\"window.open('wee-verify.php','fieldvalue','top=100,left=200,height=700,width=800,resizable=yes,scrollbars=yes,menubar=no,addressbar=no,status=yes')\" type=button name=button value=\"  Verify \">";
$html_output .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
$html_output .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
$html_output .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
$html_output .= "<input title=\"Manage your keys\" class=crmbutton onclick=\"window.open('wee-keys.php','fieldvalue','top=100,left=200,height=700,width=800,resizable=yes,scrollbars=yes,menubar=no,addressbar=no,status=yes')\" type=button name=button value=\"  Key Management\">";
//<!--#######################################-->
